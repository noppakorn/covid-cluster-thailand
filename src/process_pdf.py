...
def extract_cluster(pdf_path : str, pages : set) -> pd.DataFrame:
    ...
    df[["new_cases", "total"]] = df[["new_cases", "total"]].replace(regex_comma,"").astype(int)

    return df[["province_th", "province_en", "district_th", "district_en", "place_of_outbreak", "start_date", "new_cases", "total"]]
